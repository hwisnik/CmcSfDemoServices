...
namespace DataAccess
{
    public static class DataAccessHelper
    {
        ...
        public static string StringifyDapperDynamicParam(DynamicParameters dynamicParams)
        {
            ...
            foreach (var paramName in dynamicParams.ParameterNames)
            {
                ...
                argsDict.Add(paramName, value);
            }

            return JsonConvert.SerializeObject(argsDict);
        }
