...
namespace Unit_Tests.DependencyResolution {
    ...
    using CMCErmsServices.Handlers;
    using CMCErmsServices.DependencyResolution.Generics;
    using System.Web.Http;
    using BusinessLogic.Services;
    using CMCErmsServices.Commands;
    using CMCErmsServices.Controllers;
